...
const ErrorObject = {
  ...
  NotEnoughCoinPRVError: { code: -7003, description: "Not enough coin to spend, please faucet to get some PRVs" },
  ...
  SupportPortalTokenIDErr: { code: -20000, description: "TokenID is not supported"}
};
