...
const ErrorObject = {
  ...
  FailPushRawTxToPubsub: {code: -3013, description: "Push raw tx to pubsub failed!"},
  ...
  GetStatusTransactionErr: { code: -5000, description: "Can not get status transaction" },


  // -6000 -> -6999: Coin services error
  GetTxsByPubKeysFail: {code : -6000, description: "Get txs by pubkeys fail"},
  GetTxsByKeyImagesFail:{code : -6001, description: "Get txs by key images fail"},
