...
function checkEncode(bytearrays, version = 0, useLegacyEncoding = true) {
  new Validator("bytearrays", bytearrays).required();
  new Validator("version", version).required().number();
  new Validator("useLegacyEncoding", useLegacyEncoding).required().boolean();
...
function checkSumFirst4Bytes(data, useLegacyEncoding = true) {
  new Validator("data", data).required();
  new Validator("useLegacyEncoding", useLegacyEncoding).boolean();
  let res;
