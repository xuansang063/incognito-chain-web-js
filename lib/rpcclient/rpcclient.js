...
class RpcClient {
  ...
  estimateTxSize = (inputCoins, payments, hasPrivacy, metadata, customTokenParams, privacyCustomTokenParams) =>{
    ...
    if (privacyCustomTokenParams != null || typeof privacyCustomTokenParams)  {
      let customTokenDataSize = 0;
      ...
      // Proof
      customTokenDataSize += zkp.estimateProofSize(privacyCustomTokenParams.tokenInput.length, privacyCustomTokenParams.receiver.length, true);
