...
class RpcClient {
    ...
    getOutputCoin = async (paymentAdrr, viewingKey = "", otaKey, tokenID = null, toHeight = 0, submitted = true) => {
        let data = {
            "jsonrpc": "1.0",
    ...
    burnTokenToContract = async (privateKey, tokenID, amount, toEthAddress, isForContract = true) => {
    ...
    getOtherCoinsForRing = async (paymentAddr, numOfCoinsToGet, tokenID = null) => {
        const data = {
            "jsonrpc": "1.0",
    ...
    issueIncToken = async (privateKey, tokenID, ethBlockHash, ethDepositProof, txIndex) => {
        const data = {
            "jsonrpc": "1.0",
