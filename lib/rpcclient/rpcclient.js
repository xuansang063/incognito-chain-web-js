...
class RpcClient {
  ...
  prepareInputForTx = async (spendingKeyStr, paymentInfos) => {
    ...
    console.log("Amount payment info: ", amount);


    // get unspent coin for spending using Knapsack
    let inputCoinsToSpent;
    try{
      inputCoinsToSpent = this.chooseBestCoinToSpent(unspentCoins, amount).resultOutputCoins;
      console.log("input coin to spent : ", inputCoinsToSpent);
    } catch(e){
      console.log("e");
      throw e;
    }
