...
class RpcClient {
  ...
  getUnspentCoinExceptSpendingCoin(unspentCoins, account ){
    ...
    for (let i =0 ; i< account.spendingCoins.length; i++){
      for (let j=0; j<account.spendingCoins[i].spendingCoins.length; j++){
        console.log("Spending coin : ", account.spendingCoins)
        for (let k = 0; k < unspentCoinExceptSpeningCoin.length; k++){
          console.log("FFF account.spendingCoins[i].spendingCoins[j].toString(): ", account.spendingCoins[i].spendingCoins[j].toString());
          ...
          if (account.spendingCoins[i].spendingCoins[j].toString() === unspentCoinExceptSpeningCoin[k].coinDetails.serialNumber.compress().toString()){
