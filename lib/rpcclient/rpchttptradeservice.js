...
class RpcHTTPTradeServiceClient {
  ...
  async apiGetWithdrawContributeHistories(params) {
    ...
    new Validator("apiGetWithdrawContributeHistories-nftID", nftId).required().string();
    new Validator("apiGetWithdrawContributeHistories-poolId", poolId).required().string();
    return this.http.get(
