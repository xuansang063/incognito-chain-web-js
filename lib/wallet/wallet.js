...
class TrxHistoryInfo{
  ...
  addHistoryInfo(txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol){
    this.amount = amount;
    this.fee = fee;
    this.txID = txID;
    this.type = type;
...
class AccountWallet {
  ...
  saveNormalTx = (txID, type, amount, fee,receiver, tokenName, tokenID, tokenSymbol) => {
    let saveTrxObj = new TrxHistoryInfo();
    saveTrxObj.addHistoryInfo(txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol);
    this.trxHistory.NormalTrx.push(saveTrxObj);
  };
  saveCustomTokenTx = (txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol) =>{
    let saveTrxObj = new TrxHistoryInfo();
    saveTrxObj.addHistoryInfo(txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol);
    this.trxHistory.CustomTokenTrx.push(saveTrxObj);
  };
  savePrivacyCustomTokenTx = (txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol) => {
    let saveTrxObj = new TrxHistoryInfo();
    saveTrxObj.addHistoryInfo(txID, type, amount, fee, receiver, tokenName, tokenID, tokenSymbol);
