...
class AccountWallet {
  ...
  mergeICOStorage(allOutputCoinStrs, inputCoins, tokenID = 'constant') {
  ...
  analyzeFromICOStorage(allOutputCoinStrs, tokenID = 'constant') {
    this.iCOStorage = this.iCOStorage == undefined ? {} : this.iCOStorage
    ...
    for (let i = 0; i < allOutputCoinStrs.length; i++) {
      ...
      if (this.iCOStorage[sndStr] != undefined) {
        ...
        cachedInputCoins.push(this.iCOStorage[sndStr]);
      } else {
  ...
  mergeSCCStorage(unspentCoinStrs, inputCoins, tokenID = 'constant') {
  ...
  analyzeFromSCCStorage(inputCoins, allOutputCoinStrs, tokenID = 'constant') {
