...
import * as constantWallet from './constants'
...
class Wallet {
  ...
  async getCustomTokenBalance(privatekeyStr, tokenIDStr) {
    ...
    myKeyWallet.KeySet.importFromPrivateKey(myKeyWallet.KeySet.PrivateKey);
    let res0 = await this.rpcClient.getUnspentCustomToken(myKeyWallet.base58CheckSerialize(constantWallet.PaymentAddressType),
