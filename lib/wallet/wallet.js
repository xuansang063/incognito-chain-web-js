...
class Wallet {
  ...
  importAccount(privakeyStr, accountName, passPhrase) {
    ...
    this.MasterAccount.key.KeySet.PrivateKey = Array.from(wallet.MasterAccount.key.KeySet.PrivateKey);
    this.MasterAccount.key.KeySet.PaymentAddress.Pk = Array.from(wallet.MasterAccount.key.KeySet.PaymentAddress.Pk);
    this.MasterAccount.key.KeySet.PaymentAddress.Tk = Array.from(wallet.MasterAccount.key.KeySet.PaymentAddress.Tk);
    this.MasterAccount.key.KeySet.ReadonlyKey.Pk = Array.from(wallet.MasterAccount.key.KeySet.ReadonlyKey.Pk);
    this.MasterAccount.key.KeySet.ReadonlyKey.Rk = Array.from(wallet.MasterAccount.key.KeySet.ReadonlyKey.Rk);
    this.MasterAccount.child.push(account)
    this.save(this.PassPhrase)
    return account
  }
...
export {Wallet, AccountWallet, DefaultStorage, TrxHistoryInfo, RpcClient}