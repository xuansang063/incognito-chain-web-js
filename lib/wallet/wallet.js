  ...
  async createAndSendConstant(param, fee, isPrivacy) {
    ...
    try {
      ...
      if (response.txId) {
        ...
        object.spendingCoins = spendingSNs;
  ...
  save(password) {
    ...
    for (let i = 0; i < this.MasterAccount.child.length; i++) {
      for (let j = 0; j < this.MasterAccount.child[i].spendingCoins.length; j++) {
        for (let k = 0; k < this.MasterAccount.child[i].spendingCoins[j].spendingCoins.length; k++) {
          this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k] = Array.from(this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);
          console.log("save wallet this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]:", this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);
        }
      }
    }
      ...
      try {
        ...
        for (let i = 0; i < obj.MasterAccount.child.length; i++) {
          ...
          for (let j = 0; j < obj.MasterAccount.child[i].spendingCoins.length; j++) {
            for (let k = 0; k < obj.MasterAccount.child[i].spendingCoins[j].spendingCoins.length; k++) {
              Object.setPrototypeOf(obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k], Array.prototype);

              console.log("Load Wallet obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k] before: ", obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);
              obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k] = new Uint8Array(obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k])

              console.log("Load Wallet obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k] after: ", obj.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);


              // this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k] = Array.from(this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);
              // console.log("this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]:" , this.MasterAccount.child[i].spendingCoins[j].spendingCoins[k]);
            }
          }
      ...
      for (let j = 0; j < this.MasterAccount.child[i].trxHistory.NormalTrx.length; j++) {
        if (this.MasterAccount.child[i].trxHistory.NormalTrx[j].status == SuccessTx) {
          ...
          if (response.err === null && response.res) {
            ...
            this.MasterAccount.child[i].removeObjectFromSpendingCoins(this.MasterAccount.child[i].trxHistory.NormalTrx[j].txID);
