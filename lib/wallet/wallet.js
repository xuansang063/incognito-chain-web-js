...
class AccountWallet {
  ...
  /**
    tokenData = [{Amount: 10000
    ID: "000000000000000000000000000000000000000000000a090807060504030201"
    Image: "data:image/png;base64,"
    IsPrivacy: false
    ListTxs: null
    Name: "BondTest"
    Symbol: "BONTest"
 ...
 */
  ...
  saveNormalTx(tx, amount, receivers, tokenName, tokenID, tokenSymbol, status) {
    let saveTrxObj = new TrxHistoryInfo();
    saveTrxObj.addHistoryInfo(tx.txId, tx.type, amount, tx.fee, receivers, tokenName, tokenID, tokenSymbol, tx.lockTime);
    saveTrxObj.updateStatus(status);
    this.trxHistory.NormalTrx.push(saveTrxObj);
  };

  saveCustomTokenTx(tx, receivers, status) {

    let saveTrxObj = new TrxHistoryInfo();
    saveTrxObj.addHistoryInfo(tx.txId, tx.type, tx.txTokenData.amount, tx.fee, receivers, tx.txTokenData.propertyName, tx.txTokenData.propertyID, tx.txTokenData.propertySymbol, tx.lockTime);
    saveTrxObj.updateStatus(status);
    this.trxHistory.CustomTokenTrx.push(saveTrxObj);
  };

  savePrivacyCustomTokenTx(tx, receivers, status) {
    let saveTrxObj = new TrxHistoryInfo();
    // , receiverPaymentAddrStr,
    saveTrxObj.addHistoryInfo(tx.txId, tx.type, tx.txTokenPrivacyData.amount, tx.fee, receivers, tx.txTokenPrivacyData.propertyName, tx.txTokenPrivacyData.propertyID, tx.txTokenPrivacyData.propertySymbol, tx.lockTime);
    saveTrxObj.updateStatus(status);
  ...
  async createAndSendConstant(paymentInfos, receiverPaymentAddrStr) {
    ...
    try {
      ...
      this.saveNormalTx(tx, amount, receiverPaymentAddrStr, null, null, null, status);
  ...
  async createAndSendCustomToken(paymentInfos = null, tokenParams, receiverPaymentAddrStr) {
    ...
    try {
      ...
      this.saveCustomTokenTx(tx, receiverPaymentAddrStr, status);
      console.log("history: ", this.trxHistory);
    ...
    try {
      ...
      if (responseSendTX.txId) {
        ...
        if (tx.txTokenPrivacyData.type == constantsTx.CustomTokenInit) {
          this.addFollowingToken(tx.txTokenPrivacyData);
          console.log("List following token after adding: ", this.followingTokens);
        }
      }

      this.savePrivacyCustomTokenTx(tx, receiverPaymentAddrStr, status);
      console.log("history: ", this.trxHistory);
