...
class AccountWallet {
   ...
   * @param {number} contributedAmount 
   */
  async createAndSendPTokenContributionTx(tokenParam, feeNativeToken, pdeContributionPairID, contributedAmount) {
    await Wallet.updateProgressTx(10);
   ...
   * @param {number} sellAmount 
   */
  async createAndSendPTokenTradeRequestTx(tokenParam, feeNativeToken, tokenIDToBuyStr, sellAmount) {
    await Wallet.updateProgressTx(10);
