...
class AccountWallet {
    constructor() {
      ...
      this.followingTokens = [
        {ID: 'ffd8d42dc40a8d166ea4848baf8b5f6e912ad79875f4373070b59392b1756c8f', Image: '', Name: 'pETH', Symbol: '', Amount: 0, IsPrivacy: true, isInit: false},
        {ID: 'b832e5d3b1f01a4f0623f7fe91d6673461e1f5d37d91fe78c5c2e6183ff39696', Image: '', Name: 'pBTC', Symbol: '', Amount: 0, IsPrivacy: true, isInit: false}
      ];
    ...
    async createAndSendPrivacyCustomToken (paymentInfos = null, submitParam, fee, hasPrivacyForToken) {
      await Wallet.updateProgressTx(10);
      ...
      try {
        ...
        try {
          ...
          await tx.init(this.key.KeySet.PrivateKey, 
            paymentAddressStr, paymentInfos, 
