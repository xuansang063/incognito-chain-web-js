...
import {generateCommitteeFromHashPrivateKey} from "../committeekey";
...
class AccountWallet {
  ...
  // fee in Number
  async createAndSendStakingTx(param, fee, candidatePaymentAddress, isRewardFunder = false, candidateHashPrivateKey) {
    await Wallet.updateProgressTx(10)
    ...
    let keyWallet2 = KeyWallet.base58CheckDeserialize(candidatePaymentAddress);
    let publicKeyBytes = keyWallet2.KeySet.PaymentAddress.Pk;
