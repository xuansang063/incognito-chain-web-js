...
class AccountWallet {
  constructor() {
    ...
    this.followingTokens = [
      ...
      {
        ID: 'b2655152784e8639fa19521a7035f331eea1f1e911b2f3200a507ebb4554387b',
        Image: '',
        Name: 'Binance Coin',
        Symbol: 'pBNB',
        Amount: 0,
      ...
      {
        ID: '60b7525fe6f43ecfdabed0e5b2eeab6b602e018693dce89dc97fc8492db1c512',
        Image: '',
        Name: 'KuCoin Shares',
        Symbol: 'pKCS',
        Amount: 0,
  ...
  async createAndSendConstant(paramPaymentInfos, fee, isPrivacy, info) {
    ...
    try {
      ...
      try {
        ...
        throw new CustomError(ErrorObject.PrepareInputNormalTxErr, "Prepare input coins for transaction transfer PRV error");
      }
  ...
  // fee in Number
  async createAndSendStakingTx(param, fee, candidatePaymentAddress, isRewardFunder = false) {
    await Wallet.updateProgressTx(10)
    ...
    try {
      ...
      console.log("ERR get staking amount");
    ...
    let meta = {
      Type: type,
      FunderPaymentAddress: this.key.base58CheckSerialize(PaymentAddressType),
    ...
    try {
      ...
      try {
        ...
        throw new CustomError(ErrorObject.PrepareInputNormalTxErr, "Can not prepare input coins for staking tx");
      }
