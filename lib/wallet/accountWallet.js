...
class AccountWallet {
   ...
   * @param {string} info
   */
  async createAndSendNativeTokenTradeRequestTx(fee, tokenIDToBuyStr, sellAmount, minimumAcceptableAmount, info = "") {
    await Wallet.updateProgressTx(10);
    if (fee < 0) {
      fee = 0
    }
   ...
   * @param {number} minimumAcceptableAmount
   */
  async createAndSendPTokenTradeRequestTx(tokenParam, feeNativeToken, feePToken, tokenIDToBuyStr, sellAmount, minimumAcceptableAmount) {
    await Wallet.updateProgressTx(10);
