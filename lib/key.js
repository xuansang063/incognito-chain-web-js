...
function GeneratePrivateKey(seed) {
  ...
  let privateKeyB64Encode = wasmFuncs.generateKeyFromSeed(seedB64Encode);
...
function GeneratePublicKey(privateKey) {
  ...
  let publicKeyB64Encode = wasmFuncs.scalarMultBase(privateKeyB64Encode);
...
function GenerateReceivingKey(privateKey) {
  ...
  let receivingKeyB64Encode = wasmFuncs.generateKeyFromSeed(privateKeyB64Encode);
...
function GenerateTransmissionKey(receivingKey) {
  ...
  let transmissionKeyB64Encode = wasmFuncs.scalarMultBase(receivingKeyB64Encode);
