...
async function GeneratePrivateKey(seed) {
  ...
  let privateKeyB64Encode = await wasmFuncs.generateKeyFromSeed(seedB64Encode);
...
async function GeneratePublicKey(privateKey) {
  ...
  let publicKeyB64Encode = await wasmFuncs.scalarMultBase(privateKeyB64Encode);
...
async function GenerateReceivingKey(privateKey) {
  ...
  let receivingKeyB64Encode = await wasmFuncs.generateKeyFromSeed(privateKeyB64Encode);
...
async function GenerateTransmissionKey(receivingKey) {
  ...
  let transmissionKeyB64Encode = await wasmFuncs.scalarMultBase(receivingKeyB64Encode);
