...
class PaymentAddress {
  ...
  fromSpendingKey(spendingKey) {
    this.PublicKey = GeneratePublicKey(spendingKey);
    this.TransmissionKey = GenerateTransmissionKey(GenerateReceivingKey(spendingKey));
    return this;
  }
  ...
  toBytes() {
    ...
    paymentAddrBytes.set(this.TransmissionKey, constants.PUBLIC_KEY_SIZE);
  ...
  //     this.TransmissionKey = new Uint8Array(bytes.slice(constants.PUBLIC_KEY_SIZE));
  //     return this
  // }
}
