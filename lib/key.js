...
function GeneratePrivateKey(seed) {
    ...
    return hashSha3BytesToBytes(seed);
}
...
//     let receivingKeyB64Encode = await wasm.generateKeyFromSeed(privateKeyB64Encode);
...
//     let transmissionKeyB64Encode = await wasm.scalarMultBase(receivingKeyB64Encode);
