...
class Coin {
  ...
  convertCoinToStr(){
    let res = new Coin();
    res.publicKey = base58.checkEncode(this.publicKey.compress(), constants.PRIVACY_VERSION);
    res.coinCommitment = base58.checkEncode(this.coinCommitment.compress(), constants.PRIVACY_VERSION);
    res.snderivator = base58.checkEncode(this.snderivator.toArray(), constants.PRIVACY_VERSION );
    res.serialNumber = base58.checkEncode(this.serialNumber.compress(), constants.PRIVACY_VERSION);
    res.randomness = base58.checkEncode(this.randomness.toArray(), constants.PRIVACY_VERSION);
    res.value = base58.checkEncode(this.value.toArray(), constants.PRIVACY_VERSION);
    res.info = base58.checkEncode(this.info, constants.PRIVACY_VERSION )
...
class InputCoin {
  ...
  convertInputCoinToStr(){
    let res = new InputCoin();
    res.coinDetails = this.coinDetails;
    res.coinDetails = res.coinDetails.convertCoinToStr();
    return res;
  }
}
