...
KeyWallet.deserialize = deserialize;
KeyWallet.base58CheckDeserialize = base58CheckDeserialize;
KeyWallet.getKeySetFromPrivateKeyStr = getKeySetFromPrivateKeyStr;

async function NewMasterKey(seed) {
    // HmacSHA512(data, key)
    ...
    await keySet.generateKey(keyBytes);
