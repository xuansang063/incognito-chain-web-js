...
class AccountWallet {
  ...
  getKeyStorageByTokenId(tokenId) {
    ...
    const prefix = this.privacyVersion === 2 ? "PRIVACY-V2-" : "";
  ...
  async getUnspentCoinsV1(tokenId) {}
  ...
  async getUnspentCoins(tokenId, privacyVersion = 2) {
    try {
      this.privacyVersion = privacyVersion;
      switch (privacyVersion) {
        case 1:
