...
import keySet from "@lib/module/Account/account.keySet";
import historyPToken from "@lib/module/Account/account.historyPToken";
...
class Account {
  constructor(w = null) {
    ...
    this.rpcApiService = w.RpcApiService
      ...
      : null;
    this.rpcCoinService2 = new RpcHTTPCoinServiceClient('http://51.161.119.66:9080');
