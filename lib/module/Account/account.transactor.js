...
import { newParamTxV2, prepareInputForConvertTxV2, prepareInputForTxV2 } from '@lib/tx/utils';
...
async function _transactConvert({ transfer: {
    fee,
    info = "",
    tokenID = null,
    prvPayments = [],
  ...
  try{
    if (isTokenConvert){
      ...
      if (isDefrag){
        ...
        inputForTx = await prepareInputForConvertTxV2(-1, fee, null, account, 1, 0);
      }
    }
...
export default { createAndSendNativeToken, _transact, createAndSendConvertTx, _transactConvert };
