...
async function getOTAReceive() {
  console.log('getOTAReceive type: ', typeof wasm.createOTAReceiver)
  const otaReceiver = await wasm.createOTAReceiver(this.getPaymentAddress());
  console.log("otaReceiver", otaReceiver);
  return otaReceiver;
}
