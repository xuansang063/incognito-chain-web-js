...
class TxCustomTokenPrivacy extends Tx {
    ...
    convertTxCustomTokenPrivacyToByte(){
        ...
        // this.txTokenPrivacyData.propertyID = newHashFromStr(this.txTokenPrivacyData.propertyID);
    ...
    async init(senderSK, paymentAddressStr,  paymentInfo, inputCoins, inputCoinStrs, fee, tokenParams, listCustomTokens, metaData, hasPrivacy) {
        ...
        switch (tokenParams.tokenTxType) {
            ...
            case constantsTx.CustomTokenTransfer: {
                ...
                let err = await txNormal.init(senderSK, paymentAddressStr, tokenParams.receiver, tokenParams.tokenInputs, tokenInputsStr , fee, true, tokenParams.propertyID, null);
                if (err !==null)
                {
