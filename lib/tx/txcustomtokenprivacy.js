  ...
  async init(senderSK, paymentAddressStr, paymentInfo, inputCoins, inputCoinStrs, fee, tokenParams, listCustomTokens, metaData, hasPrivacy) {
    ...
    switch (tokenParams.tokenTxType) {
      ...
      case constantsTx.CustomTokenTransfer: {
        ...
        let tokenInputsStr = this.rpcClient.parseInputCoinToStr(tokenParams.tokenInput);

        let err = await txNormal.init(senderSK, paymentAddressStr, tokenParams.receiver, tokenParams.tokenInput, tokenInputsStr, fee, true, tokenParams.propertyID, null);
        if (err !== null) {
