        ...
        switch (tokenParams.tokenTxType) {
            ...
            case constantsTx.CustomTokenTransfer: {
                ...
                for (i=0;i<listCustomTokens.length; i++){
                    if (listCustomTokens[i].ID === tokenParams.propertyID){
                        break;
                    }
                }
                ...
                let tokenInputsStr = this.rpcClient.parseInputCoinToStr(tokenParams.tokenInputs);

                let err = txNormal.init(senderSK, paymentAddressStr, tokenParams.receiver, tokenParams.tokenInputs, tokenInputsStr , fee, true, tokenParams.propertyID, null);
                if (err !==null)
                {
