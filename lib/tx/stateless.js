...
class StatelessTransactor extends Account {
    ...
    async waitBalanceChange(tokenID) {
    ...
    /**
     * @returns {Object} a new TxBuilder for tx creation
     */
    tx() {
...
class TxBuilder {
    ...
    withAccess(ota) {
        this.params.transfer.tokenCoinChooser = new AccessTicketChooser(ota, this.useBase58Encoding);
    ...
    */
    ...
    contribute(burnAmount, amplifier = 10000, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            let receiver = await generateOTAReceivers([tokenID, PDEX_ACCESS_ID], this.transactor.key.base58CheckSerialize(PaymentAddressType));
    ...
    contributeMore(burnAmount, accessID, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                TokenID: tokenID,
                Amplifier: amplifier,
                OtaReceivers: await generateOTAReceivers([tokenID, PDEX_ACCESS_ID], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
                AccessID: accessID,
                Type: pdexv3.AddLiquidityRequestMeta,
            };
        }
    ...
    trade(sellAmount, minBuyAmount = 0, tradingFee = 100, tradingFeeInPRV = false, tradePath = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                Receiver: await generateOTAReceivers([tokenIDSell, tokenIDBuy, PRVIDSTR], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    order(sellAmount, buyAmount, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                SellAmount: sellAmount,
                TokenToSell: tokenIDSell,
                Receiver: await generateOTAReceivers([tokenIDSell, tokenIDBuy, PDEX_ACCESS_ID], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
                RewardReceiver: await generateOTAReceivers([PRVIDSTR, tokenIDSell], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    withdrawLiquidity(shareAmount, accessID, poolTokenIDs = null, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                AccessID: accessID,
                OtaReceivers: await generateOTAReceivers([PDEX_ACCESS_ID].concat(poolTokenIDs), this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    withdrawOrder(orderID, accessID, withdrawTokenIDs = null, poolID = null, amount = 0) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                BurntOTA: this.params.transfer.tokenCoinChooser.accessTicket,
                AccessID: accessID,
                Receiver: await generateOTAReceivers([PDEX_ACCESS_ID].concat(withdrawTokenIDs), this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    dexUnstake(amount, accessID) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                BurntOTA: this.params.transfer.tokenCoinChooser.accessTicket,
                AccessID: accessID,
                OtaReceivers: await generateOTAReceivers([PDEX_ACCESS_ID, stakingPoolID], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    withdrawRewardLP(accessID, withdrawTokenIDs = null, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                BurntOTA: this.params.transfer.tokenCoinChooser.accessTicket,
                AccessID: accessID,
                Receivers: await generateOTAReceivers([PDEX_ACCESS_ID, PRVIDSTR].concat(withdrawTokenIDs), this.transactor.key.base58CheckSerialize(PaymentAddressType)),
    ...
    withdrawRewardStaking(accessID, poolID = null) {
        ...
        this.params.extra.metadata = async () => {
            return {
                ...
                BurntOTA: this.params.transfer.tokenCoinChooser.accessTicket,
                AccessID: accessID,
                Receivers: await generateOTAReceivers([PDEX_ACCESS_ID, stakingPoolID], this.transactor.key.base58CheckSerialize(PaymentAddressType)),
