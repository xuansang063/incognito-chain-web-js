...
class Tx {
  ...
  async init(senderSK, paymentAddressStr, paymentInfo, inputCoins, inputCoinStrs, fee, hasPrivacy, tokenID, metaData, info = "") {
    console.time("check input and create new output: ");
    // clone input coins
    ...
    console.timeEnd("check input and create new output: ");

    // create zero knowledge proof of payment

    console.time("init witness for zero knowledge proof: ");
    ...
    console.timeEnd("init witness for zero knowledge proof: ");
